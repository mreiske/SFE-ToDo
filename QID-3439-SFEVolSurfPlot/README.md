...
Description : 'Produces a graphic visualisation of the implied volatility surface of the DAX
option. The original options are shown as blue points.'

Keywords : 'bisection-method, black-scholes, data visualization, dax, financial, graphical
representation, implied-volatility, index, option, plot, surface, visualization, volatility'

See also : SFEPCA, SFEVolaCov, SFEVolaPCA, SFEVolaTermStructure

Author : Maria Grith, Awdesch Melzer
