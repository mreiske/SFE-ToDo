...
% Quantlet:     SFEVasiml
% ---------------------------------------------------------------------
% Description:  SFEVasiml shows the estimation of Vasicek model
%               using 2600 observations of the yields of the US 3 month
%               treasury bill from 19980102 to 20080522
% ---------------------------------------------------------------------
% Usage:        Vasiml
% ---------------------------------------------------------------------
% Inputs:       The yields of the US 3 month treasury bill from 1998 to
%               2008
% ---------------------------------------------------------------------
